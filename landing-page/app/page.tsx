      ...
      <section className="features section" id="features" aria-labelledby="features-title">
        <div className="section-heading"><div className="section-kicker"><span>02</span><i /> FEATURES</div><h2 id="features-title">強くなるための、<br /><em>3つの視点。</em></h2></div>
          ...
          <article className="feature-match feature-block" id="match">
            <div className="match-copy feature-copy"><FeatureLabel number="A">MATCH</FeatureLabel><h3>ちゃんと対局する。</h3><p>オンラインで対局し、その一局を次の学びにつなげます。単に勝敗を決めるだけではなく、その後の検討・分析につながる対局体験です。残り時間の音による通知や、任意で使える集中用ピンクノイズにも対応しています。</p><Tags items={tags.match} /></div>
