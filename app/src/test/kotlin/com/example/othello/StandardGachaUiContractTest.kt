...
class StandardGachaUiContractTest {
    ...
    fun gachaHasCapsuleCrackGlowRevealAndCollectionExit() {
        ...
        assertTrue("effectiveRightShellBitmap = rightShellBitmap ?: leftShellBitmap" in source)
        assertTrue("mirrorRightShellFallback = rightShellBitmap == null && leftShellBitmap != null" in source)
        assertTrue("scaleX = if (mirrorRightShellFallback) -1f else 1f" in source)
