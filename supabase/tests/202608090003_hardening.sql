...
select set_config('request.jwt.claim.sub', '00000000-0000-0000-0000-000000000003', false);
select throws_ok($$select public.submit_match_result('00000000-0000-0000-0000-000000000104', 'd3c3b3b2b1a1c4c1c2d2d1e1a2a3f5e2f1g1--f2--e3--b5b4a5a4c5a6f4f3g3g2h2h1h3h4g4c6g5h5b6c7d6e6f6g6h6h7a7--b7a8d7e7f7g7g8b8c8d8e8f8h8', 'WHITE_WIN', '712ca7384132c0b4:1:0:64', 'NORMAL', null)$$, 'P0001', 'match P2P not started', 'result submit is rejected before both start acks');
...
select public.ack_match_started('00000000-0000-0000-0000-000000000105');
select set_config('request.jwt.claim.sub', '00000000-0000-0000-0000-000000000003', false);
select is((select public.submit_match_result('00000000-0000-0000-0000-000000000105', 'd3c3b3b2b1a1c4c1c2d2d1e1a2a3f5e2f1g1--f2--e3--b5b4a5a4c5a6f4f3g3g2h2h1h3h4g4c6g5h5b6c7d6e6f6g6h6h7a7--b7a8d7e7f7g7g8b8c8d8e8f8h8', 'WHITE_WIN', '712ca7384132c0b4:1:0:64', 'NORMAL', null)::text), 'PENDING_RESULT', 'first authoritative result is pending for normal finalization');
select set_config('request.jwt.claim.sub', '00000000-0000-0000-0000-000000000004', false);
select is((select public.submit_match_result('00000000-0000-0000-0000-000000000105', 'd3c3b3b2b1a1c4c1c2d2d1e1a2a3f5e2f1g1--f2--e3--b5b4a5a4c5a6f4f3g3g2h2h1h3h4g4c6g5h5b6c7d6e6f6g6h6h7a7--b7a8d7e7f7g7g8b8c8d8e8f8h8', 'WHITE_WIN', '712ca7384132c0b4:1:0:64', 'NORMAL', null)::text), 'CONFIRMED', 'second authoritative result auto-finalizes');
...
select is((select public.submit_match_result('00000000-0000-0000-0000-000000000105', 'd3c3b3b2b1a1c4c1c2d2d1e1a2a3f5e2f1g1--f2--e3--b5b4a5a4c5a6f4f3g3g2h2h1h3h4g4c6g5h5b6c7d6e6f6g6h6h7a7--b7a8d7e7f7g7g8b8c8d8e8f8h8', 'WHITE_WIN', '712ca7384132c0b4:1:0:64', 'NORMAL', null)::text), 'CONFIRMED', 'duplicate terminal submit is idempotent');
...
select is((select final_position_hash from public.game_records where match_id = '00000000-0000-0000-0000-000000000105'), '712ca7384132c0b4:1:0:64', 'confirmed record retains the server-derived final position hash');
...
select throws_ok($$select public.submit_match_result('00000000-0000-0000-0000-000000000107', '', 'BLACK_WIN', '0000000000000000:0:0:0', 'NORMAL', null)$$, 'P0001', 'match P2P not started', 'result replay is unavailable before both start acks');
...
select public.ack_match_started('00000000-0000-0000-0000-000000000107');
select set_config('request.jwt.claim.sub', '00000000-0000-0000-0000-000000000005', false);
select throws_ok($$select public.submit_match_result('00000000-0000-0000-0000-000000000107', '', 'BLACK_WIN', (select final_position_hash from public.release_replay_game_v2('')), 'NORMAL', null)$$, 'P0001', 'NORMAL result is not terminal', 'NORMAL cannot submit zero-ply canonical history');
select is((select public.submit_match_result('00000000-0000-0000-0000-000000000107', '', 'BLACK_WIN', (select final_position_hash from public.release_replay_game_v2('')), 'RESIGNATION', null)::text), 'PENDING_RESULT', 'zero-ply resignation is accepted as pending evidence');
select set_config('request.jwt.claim.sub', '00000000-0000-0000-0000-000000000006', false);
select is((select public.submit_match_result('00000000-0000-0000-0000-000000000107', '', 'BLACK_WIN', (select final_position_hash from public.release_replay_game_v2('')), 'RESIGNATION', null)::text), 'CONFIRMED', 'loser-confirmed zero-ply resignation finalizes');
